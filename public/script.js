...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ===== CONFIGURACIÓN =====
    // Usar CONFIG global o valores por defecto
    ...
    async function handleSendMessage() {
        ...
        try {
            ...
            addMessage(`Parece que hubo un problema técnico. Te sugiero:

1. **Continuar por WhatsApp directo:** <a href="https://wa.me/${CONFIG.WHATSAPP_PHONE}" target="_blank" style="color: #25D366; font-weight: bold;">Hacé clic aquí para WhatsApp</a>
2. **Intentar de nuevo en un momento**
